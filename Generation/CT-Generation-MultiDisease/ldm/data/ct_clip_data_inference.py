...
class CTReportDatasetinfer(Dataset):
    def __init__(self, data_folder, csv_file, json_file, min_slices=20, resize_dim=500, force_num_frames=True):
    ...
    def __getitem__(self, index):
        ...
        example['disease_mask_channel'] = disease_mask_channel
        example['disease_label'] = disease_label
        return example