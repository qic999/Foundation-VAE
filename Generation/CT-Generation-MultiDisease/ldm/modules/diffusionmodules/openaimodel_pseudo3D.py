...
class PseudoConv3d(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.temporal_conv = nn.Conv1d(dim_out, dim_out, kernel_size = temporal_kernel_size, padding = temporal_kernel_size // 2, padding_mode='reflect') if kernel_size > 1 else None
