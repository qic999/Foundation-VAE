...
logdir = 'logs/full_ct_2d_with_body_mask2/'
ckpt = os.path.join(logdir, "checkpoints", "epoch=000317.ckpt")
...
config = OmegaConf.load('./configs/latent-diffusion/full_ct_2d_with_body_mask2.yaml')
