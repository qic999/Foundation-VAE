...
configs_file = "configs/latent-diffusion/infer_train.yaml"
...
config = OmegaConf.load('./configs/latent-diffusion/infer_train.yaml')
data = instantiate_from_config(config.data)
data.prepare_data()
data.setup()

# save_path = f'3d_results_step{ddim_steps}_train_latest'
save_path = f'infer_train'
...
save_gt = True
print('validation set num:', val_num)
breakpoint()
