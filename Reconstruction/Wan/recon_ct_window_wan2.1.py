...
def main_dir(input_dir, output_dir, window_size=65, checkpoint_dir=None, skip_existing=True):
    ...
    if checkpoint_dir is None:
        checkpoint_dir = '/home/v-qichen3/debug/Wan2.1-VACE-1.3B'
    
    # 初始化VAE模型
    print("Loading VAE model...")
    vae = Wan2_1_VAE(vae_pth=os.path.join(checkpoint_dir, 'Wan2.1_VAE.pth'))
...
if __name__ == '__main__':
    ...
    output_dir = './reconstructed_results_wan2.1_lung'
